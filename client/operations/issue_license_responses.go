...
/* IssueLicenseOK describes a response with status code 200, with default header values.
...
func (o *IssueLicenseOK) GetPayload() *models.License {
	return o.Payload
}
...
/* IssueLicenseDefault describes a response with status code -1, with default header values.
...
func (o *IssueLicenseDefault) GetPayload() *models.Error {
	return o.Payload
}
