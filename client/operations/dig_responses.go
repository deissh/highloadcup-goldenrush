...
/* DigOK describes a response with status code 200, with default header values.

List of treasures found.
*/
type DigOK struct {
	Payload models.TreasureList
}

func (o *DigOK) Error() string {
	return fmt.Sprintf("[POST /dig][%d] digOK  %+v", 200, o.Payload)
}
func (o *DigOK) GetPayload() models.TreasureList {
	return o.Payload
}
...
/* DigDefault describes a response with status code -1, with default header values.
...
func (o *DigDefault) GetPayload() *models.Error {
	return o.Payload
}
